      ...
      <div className="bottomnav">
        <div className="bottomsmallabout">
          ...
          <a href="https://neupokoev.xyz/rss.xml" target="_blank" rel="external nofollow noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="social-icon" aria-hidden="true" focusable="false">
        ...
        <div className="bottomxsocial">
          ...
          <div className="bottomlist">
            <a href="https://mastodon.social/@mikolasan" target="_blank" rel="external nofollow noopener noreferrer me">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor" class="social-icon" aria-hidden="true" focusable="false">
            ...
            <a href="https://discord.gg/FhbAshWjcB" target="_blank" rel="external nofollow noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="currentColor" class="social-icon" aria-hidden="true" focusable="false">
                {/* Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc. */}
            ...
            <a href="https://github.com/mikolasan" target="_blank" rel="external nofollow noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" fill="currentColor" class="social-icon" aria-hidden="true" focusable="false">
                {/* Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc. */}
            ...
            <a href="https://twitter.com/mikolasan" target="_blank" rel="external nofollow noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="social-icon" aria-hidden="true" focusable="false">
                {/* Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc. */}
