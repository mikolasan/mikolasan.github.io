export const articles = [
  ...
  },
  {
    ...
    subtitle: `Free, For Everyone, and Let No One Be Forgotten`,
    url: `/linux/upgrade-android-on-nvidia-shield#android-flavors`,
    excerpt: `<p>Here is the story of how I started upgrading Android on my Nvidia Shield tablet
    because one day I saw a popup in the app, where I read ebooks from my public library,
    that soon they will drop support of Android 7.
    </p>`,
    readMore: ``,
    imgSrc: `/images/home/android-on-shield.jpg`,
    imgAlt: `Nvidia Shield tablet with TWRP running on`,
  },
  {
    style: `box3`,
    title: `PyTorch`,
